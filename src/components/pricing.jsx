        ...
        <section id='pricing' className="block pricing-block">
            ...
            <Container fluid>
                <div className="title-holder">
                    <h2>Pricing &amp; plans</h2>
                    <div className="subtitle">check our prices & plans</div>
                </div>
                <Row>

                    {
                        pricingData.map(itemPlan => {
                            return (
                                <Col sm={4} key={itemPlan.id}>
                                    <div className="heading">
                                        <h3>{itemPlan.plan}</h3>
                                        <span className='price'>{itemPlan.price}</span>
                                    </div>
                                    <div className="content">
                                        <ListGroup>
                                            {
                                                itemPlan.features.map((feature, i) => {
                                                    return (
                                    ...
                                    <div className="btn-holder">
                                        <a href={itemPlan.link} className='btn btn-primary'>Order now</a>
                                    </div>
                                </Col>
                            )
                        })
